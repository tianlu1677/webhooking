  ...
  class PasswordsController < Clearance::BaseController
    if respond_to?(:before_action)
      ...
      skip_before_filter :authorize,
                         only: %i[create edit new update],
                         raise: false
      before_filter :ensure_existing_user, only: %i[edit update]
    end
    ...
    def create
      ...
      render template: 'clearance/passwords/create'
    end
    ...
    def edit
      ...
      if params[:token]
        ...
        render template: 'clearance/passwords/edit'
      end
    end

    def new
      render template: 'clearance/passwords/new'
    end
